...
def download_pts_kml(points: dict):
    ...
    S1 = [data['properties'] for data in data_list if data['properties'].get('shape_name') in ['S1']]
    F1 = [data['properties'] for data in data_list if data['properties'].get('shape_name') in ['F1']]
