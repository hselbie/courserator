...
def add_to_location_library(data_name, shape_coords, start_coords):
    ...
    location_library.local_zone_collection[data_name]['polygon']= format_point_list(shape_coords) 
    location_library.local_zone_collection[data_name]['start_points']= format_point_list(start_coords)
    return data_name
