...
def sort_distances(dist_list):
   ...
   dd = max([sorted_list[-tranches:]])
   sample = {}
   sample['top'] = {max([sorted_list[-tranches:]]):min([sorted_list[-tranches:]])}
   sample['middle'] = {max([sorted_list[tranches:-tranches]]):min([sorted_list[tranches:-tranches]])}
   sample['bottom'] = {max([sorted_list[0:tranches]]): min([sorted_list[0:tranches]])}
   return sample
