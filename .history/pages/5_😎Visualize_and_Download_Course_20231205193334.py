...
with open(f'output/{course_name}.kml', 'rb') as f:
    st.download_button('Download Course', f, file_name=f'{course_name}.kml')  # Defaults to 'application/octet-stream'
link = '[Checksites Maprun Link](https://console.maprun.net/#/check_sites_create)'
st.markdown(link, unsafe_allow_html=True)

start_again = st.button()
